/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: b5c81f9dd77ca9c4dd8f167798d3c196)
// Runtime types generated with workerd@1.20260507.1 2026-05-09 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* chat-app-landing */;
	}
}
