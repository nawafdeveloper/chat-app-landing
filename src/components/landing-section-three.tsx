...
const mediaTypes = [
    {
        label: "Photos",
        detail: "Share moments in the chat",
        icon: (
    ...
    {
        label: "Files",
        detail: "Pass along useful documents",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="currentColor">
...
const messageRows = [
    "Text messages that feel instant",
    "Photos, videos, files, and voice notes",
    "A clean chat space for everyday conversations",
];

export default function LandingSectionThree() {
    return (
        <div className="flex w-full min-w-0 flex-col overflow-x-hidden">
            <section id="media" className="bg-[#111b21] px-4 py-14 text-white sm:px-6 sm:py-20 lg:px-10">
                <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.88fr_1fr]">
                        ...
                        {mediaTypes.map((item) => (
                            <div key={item.label} className="p-5">
                                <span className="flex flex-row items-center gap-x-4">
                                    ...
                                    <p className="text-2xl font-normal text-[#25d366]">{item.label}</p>
                                </span>
                    ...
                    <div className="space-y-6 lg:pl-10">
                        <p className="text-sm font-semibold uppercase text-[#25d366]">Send more than text</p>
